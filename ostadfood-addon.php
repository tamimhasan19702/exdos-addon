...
include_once('inc/exdos-post-type.php');
 ...
 * @since 1.2.0
 */
final class Elementor_Exdos_Addon
{
	...
	public function admin_notice_missing_main_plugin()
	{
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__('Exdos addon', 'elementor-hello-world') . '</strong>',
